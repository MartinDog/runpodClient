...
export function useCreateSession() {
  ...
  return useMutation({
    ...
    onSuccess: (_, vars) => qc.invalidateQueries({ queryKey: ['sessions', vars.userId] }),
  })
}
...
export function useSendMessage() {
  ...
  return useMutation({
    ...
    onSuccess: (_, vars) => qc.invalidateQueries({ queryKey: ['chatHistory', vars.sessionId] }),
  })
}

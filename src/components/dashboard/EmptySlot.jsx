...
export default function EmptySlot({ onClick, label = 'New Session' }) {
  return (
    <button
      onClick={onClick}
      className="bg-gray-900/50 border-2 border-dashed border-gray-700 rounded-xl p-5 flex flex-col items-center justify-center gap-3 min-h-[200px] hover:border-purple-500 hover:bg-gray-900 transition-all group"
    >
